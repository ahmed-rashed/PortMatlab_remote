...
MODULE MX_INTERFACES
    INTERFACE
        mwPointer function mxGetM(pm) bind(c, name = 'MXGETM')
            mwPointer pm
        end function mxGetM

        mwPointer function mxGetN(pm) bind(c, name = 'MXGETN')
            mwPointer pm
        end function mxGetN

        mwPointer function mxGetPr(pm) bind(c, name = 'mxGetPr')
            mwPointer pm
        end function mxGetPr

        mwPointer function mxGetPi(pm) bind(c, name = 'mxGetPi')
            mwPointer pm
        end function mxGetPi

        mwPointer function mxCreateDoubleMatrix(m, n, ComplexFlag) bind(c, name = 'mxCreateDoubleMatrix')
            mwPointer m, n
